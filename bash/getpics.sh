...
# checking dir or create new one
...
# First input checks the file if statement failes then it will download new one.
...
# first part checks download is done by last command or not. it it gives exit status 0 then it will execute the tar to extract the data in tgz archive and removes at the end
