...
myargs=()
#Use of variables to define input stat
vebosemode=0
debugmode=0
...
while [ $# -gt 0 ]; do
  ...
  *)
  ...
  shift
  #we shift the command line argument to continue with the next component
...
#Implementing if condition to test variable stat
